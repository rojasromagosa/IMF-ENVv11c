...
***South Asia
	$$IFi %GTAP_ver%=="11c"  AFG  "Afghanistan"
        BGD     "Bangladesh"
        IND     "India"
        NPL     "Nepal"
        PAK     "Pakistan"
...
***Central Asia
        ...
        KGZ     "Kyrgyzstan"
        TJK     "Tajikistan"
        $$IFi %GTAP_ver%=="11c"  UZB  "Uzbekistan"
        XSU     "Rest of Former Soviet Union"
*               - Turkmenistan

***Middle East 
        BHR     "Bahrain"
        $$IFi %GTAP_ver%=="11c"  IRQ "Iraq"
        IRN     "Islamic Republic of Iran"
        ISR     "Israel"
        JOR     "Jordan"
        KWT     "Kuwait"
	$$IFi %GTAP_ver%=="11c"  LBN "Lebanon"        
        OMN     "Oman"
        $$IFi %GTAP_ver%=="11c"  PSE "West Bank and Gaza"
        QAT     "Qatar"
        SAU     "Saudi Arabia"
	$$IFi %GTAP_ver%=="11c"  SYR "Syrian Arab Republic"
        TUR     "Turkiye"
...
***Western Africa
        ...
        GHA     "Ghana"
        GIN     "Guinea"
        $$IFi %GTAP_ver%=="11c"  MLI  "Mali"
	$$IFi %GTAP_ver%=="11c"  NER  "Niger"
        NGA     "Nigeria"
        SEN     "Senegal"
        TGO     "Togo"
...
***Central Africa
	$$IFi %GTAP_ver%=="11c"  CAF  "Central African Republic"
	$$IFi %GTAP_ver%=="11c"  COG  "Congo"
	$$IFi %GTAP_ver%=="11c"  COD  "Democratic Republic of the Congo"
	$$IFi %GTAP_ver%=="11c"  TCD  "Chad"
	$$IFi %GTAP_ver%=="11c"  GNQ  "Equatorial Guinea"
	$$IFi %GTAP_ver%=="11c"  GAB  "Gabon"

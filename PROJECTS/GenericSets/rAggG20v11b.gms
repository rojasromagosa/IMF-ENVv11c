...
* Central Asia    
    ...
    OEA.kgz
    OEA.tjk
    $$IFi %GTAP_ver%=="11b"     OEA.uzb
    OEA.xsu

* Middle East 
    ROP.bhr
    $$IFi %GTAP_ver%=="11b"     ROP.irq    
    ROP.irn
    ROP.isr
    ROP.jor
    ROP.kwt
    $$IFi %GTAP_ver%=="11b"     ROP.lbn
    ROP.omn
    $$IFi %GTAP_ver%=="11b"     ROP.pse
    ROP.qat
    sau.sau
    $$IFi %GTAP_ver%=="11b"     ROP.syr
    tur.tur
    ROP.are
    ROP.xws

* North Africa
    $$IFi %GTAP_ver%=="11b"     OAF.dza
    OAF.egy
    OAF.mar
    OAF.tun
    OAF.xnf    
...
* Western Africa
    ...
    OAF.gha
    OAF.gin
    $$IFi %GTAP_ver%=="11b"     OAF.mli
    $$IFi %GTAP_ver%=="11b"     OAF.ner
    OAF.nga
    OAF.sen
    OAF.tgo
    OAF.xwf
...
* Central Africa    
    $$IFi %GTAP_ver%=="11b"     OAF.caf
    $$IFi %GTAP_ver%=="11b"     OAF.cog
    $$IFi %GTAP_ver%=="11b"     OAF.cod
    $$IFi %GTAP_ver%=="11b"     OAF.tcd
    $$IFi %GTAP_ver%=="11b"     OAF.gnq
    $$IFi %GTAP_ver%=="11b"     OAF.gab

    $$IFi %GTAP_ver%=="10.1"    OAF.xcf     
    OAF.xac

* Eastern Africa       
    $$IFi %GTAP_ver%=="11b"     OAF.com
    OAF.eth
    OAF.ken
    OAF.mdg
    OAF.mwi
